...
#else
#define _XL_EXPORT_API
#define _XL_EXPORT_DECLSPEC_DLL
#endif
...
//------------------------------------------------------------------------------
#define XL_TRANSCEIVER_LINEMODE_NA                    (0x0000)
#define XL_TRANSCEIVER_LINEMODE_TWO_LINE              (0x0001)
#define XL_TRANSCEIVER_LINEMODE_CAN_H                 (0x0002)
#define XL_TRANSCEIVER_LINEMODE_CAN_L                 (0x0003)
#define XL_TRANSCEIVER_LINEMODE_SWC_SLEEP             (0x0004)  //!< SWC Sleep Mode.
#define XL_TRANSCEIVER_LINEMODE_SWC_NORMAL            (0x0005)  //!< SWC Normal Mode.
#define XL_TRANSCEIVER_LINEMODE_SWC_FAST              (0x0006)  //!< SWC High-Speed Mode.
#define XL_TRANSCEIVER_LINEMODE_SWC_WAKEUP            (0x0007)  //!< SWC Wakeup Mode.
#define XL_TRANSCEIVER_LINEMODE_SLEEP                 (0x0008)
#define XL_TRANSCEIVER_LINEMODE_NORMAL                (0x0009)
#define XL_TRANSCEIVER_LINEMODE_STDBY                 (0x000a)  //!< Standby for those who support it
#define XL_TRANSCEIVER_LINEMODE_TT_CAN_H              (0x000b)  //!< truck & trailer: operating mode single wire using CAN high
#define XL_TRANSCEIVER_LINEMODE_TT_CAN_L              (0x000c)  //!< truck & trailer: operating mode single wire using CAN low
#define XL_TRANSCEIVER_LINEMODE_EVA_00                (0x000d)  //!< CANcab Eva
#define XL_TRANSCEIVER_LINEMODE_EVA_01                (0x000e)  //!< CANcab Eva
#define XL_TRANSCEIVER_LINEMODE_EVA_10                (0x000f)  //!< CANcab Eva
#define XL_TRANSCEIVER_LINEMODE_EVA_11                (0x0010)  //!< CANcab Eva

//------------------------------------------------------------------------------
// Transceiver Status Flags
//------------------------------------------------------------------------------
// (not all used, but for compatibility reasons)
#define XL_TRANSCEIVER_STATUS_PRESENT                 (0x0001)
#define XL_TRANSCEIVER_STATUS_POWER_GOOD              (0x0010)
#define XL_TRANSCEIVER_STATUS_EXT_POWER_GOOD          (0x0020)
#define XL_TRANSCEIVER_STATUS_NOT_SUPPORTED           (0x0040)
...
// common event tags
//
#define XL_RECEIVE_MSG                 (0x0001)
#define XL_CHIP_STATE                  (0x0004)
#define XL_TRANSCEIVER_INFO            (0x0006)
#define XL_TRANSCEIVER                 (XL_TRANSCEIVER_INFO)
#define XL_TIMER_EVENT                 (0x0008)
#define XL_TIMER                       (XL_TIMER_EVENT)
#define XL_TRANSMIT_MSG                (0x000A)
#define XL_SYNC_PULSE                  (0x000B)
#define XL_APPLICATION_NOTIFICATION    (0x000F)

//
// LIN event tags
//
#define LIN_MSG                        (0x0014)
#define LIN_ERRMSG                     (0x0015)
#define LIN_SYNCERR                    (0x0016)
#define LIN_NOANS                      (0x0017)
#define LIN_WAKEUP                     (0x0018)
#define LIN_SLEEP                      (0x0019)
#define LIN_CRCINFO                    (0x001A)

//
// DAIO event tags
//
#define RECEIVE_DAIO_DATA              (0x0020)  //!< D/A IO data message

#define KLINE_MSG                      (0x0024)
...
// FlexRay event tags
//
#define XL_FR_START_CYCLE                (0x0080)
#define XL_FR_RX_FRAME                   (0x0081)
#define XL_FR_TX_FRAME                   (0x0082)
#define XL_FR_TXACK_FRAME                (0x0083)
#define XL_FR_INVALID_FRAME              (0x0084)
#define XL_FR_WAKEUP                     (0x0085)
#define XL_FR_SYMBOL_WINDOW              (0x0086)
#define XL_FR_ERROR                      (0x0087)
#define XL_FR_ERROR_POC_MODE             (0x01)
#define XL_FR_ERROR_SYNC_FRAMES_BELOWMIN (0x02)
#define XL_FR_ERROR_SYNC_FRAMES_OVERLOAD (0x03)
#define XL_FR_ERROR_CLOCK_CORR_FAILURE   (0x04)
#define XL_FR_ERROR_NIT_FAILURE          (0x05)
#define XL_FR_ERROR_CC_ERROR             (0x06)
#define XL_FR_STATUS                     (0x0088)
#define XL_FR_NM_VECTOR                  (0x008A)
#define XL_FR_TRANCEIVER_STATUS          (0x008B)
#define XL_FR_SPY_FRAME                  (0x008E)
#define XL_FR_SPY_SYMBOL                 (0x008F)
...
// MOST150 event tags
//
#define XL_START                                    (0x0200)
#define XL_STOP                                     (0x0201)
#define XL_MOST150_EVENT_SOURCE                     (0x0203)
#define XL_MOST150_DEVICE_MODE                      (0x0204)
#define XL_MOST150_SYNC_ALLOC_INFO                  (0x0205)
#define XL_MOST150_FREQUENCY                        (0x0206)
#define XL_MOST150_SPECIAL_NODE_INFO                (0x0207)
#define XL_MOST150_CTRL_RX                          (0x0208)
#define XL_MOST150_CTRL_TX_ACK                      (0x0209)
#define XL_MOST150_ASYNC_SPY                        (0x020A)
#define XL_MOST150_ASYNC_RX                         (0x020B)
#define XL_MOST150_SYNC_VOLUME_STATUS               (0x020D)
#define XL_MOST150_TX_LIGHT                         (0x020E)
#define XL_MOST150_RXLIGHT_LOCKSTATUS               (0x020F)
#define XL_MOST150_ERROR                            (0x0210)
#define XL_MOST150_CONFIGURE_RX_BUFFER              (0x0211)
#define XL_MOST150_CTRL_SYNC_AUDIO                  (0x0212)
#define XL_MOST150_SYNC_MUTE_STATUS                 (0x0213)
#define XL_MOST150_LIGHT_POWER                      (0x0214)
#define XL_MOST150_GEN_LIGHT_ERROR                  (0x0215)
#define XL_MOST150_GEN_LOCK_ERROR                   (0x0216)
#define XL_MOST150_CTRL_BUSLOAD                     (0x0217)
#define XL_MOST150_ASYNC_BUSLOAD                    (0x0218)
#define XL_MOST150_ETHERNET_RX                      (0x0219)
#define XL_MOST150_SYSTEMLOCK_FLAG                  (0x021A)
#define XL_MOST150_SHUTDOWN_FLAG                    (0x021B)
#define XL_MOST150_CTRL_SPY                         (0x021C)
#define XL_MOST150_ASYNC_TX_ACK                     (0x021D)
#define XL_MOST150_ETHERNET_SPY                     (0x021E)
#define XL_MOST150_ETHERNET_TX_ACK                  (0x021F)
#define XL_MOST150_SPDIFMODE                        (0x0220)
#define XL_MOST150_ECL_LINE_CHANGED                 (0x0222)
#define XL_MOST150_ECL_TERMINATION_CHANGED          (0x0223)
#define XL_MOST150_NW_STARTUP                       (0x0224)
#define XL_MOST150_NW_SHUTDOWN                      (0x0225)
#define XL_MOST150_STREAM_STATE                     (0x0226)
#define XL_MOST150_STREAM_TX_BUFFER                 (0x0227)
#define XL_MOST150_STREAM_RX_BUFFER                 (0x0228)
#define XL_MOST150_STREAM_TX_LABEL                  (0x0229)
#define XL_MOST150_STREAM_TX_UNDERFLOW              (0x022B)
#define XL_MOST150_GEN_BYPASS_STRESS                (0x022C)
#define XL_MOST150_ECL_SEQUENCE                     (0x022D)
#define XL_MOST150_ECL_GLITCH_FILTER                (0x022E)
#define XL_MOST150_SSO_RESULT                       (0x022F)

//
// CAN/CAN-FD event tags
// Rx
#define XL_CAN_EV_TAG_RX_OK                         (0x0400)
#define XL_CAN_EV_TAG_RX_ERROR                      (0x0401)
#define XL_CAN_EV_TAG_TX_ERROR                      (0x0402)
#define XL_CAN_EV_TAG_TX_REQUEST                    (0x0403)
#define XL_CAN_EV_TAG_TX_OK                         (0x0404)
#define XL_CAN_EV_TAG_CHIP_STATE                    (0x0409)
...
// Ethernet event tags
//
#define XL_ETH_EVENT_TAG_FRAMERX                    (0x0500)  // Event data type T_XL_ETH_DATAFRAME_RX
#define XL_ETH_EVENT_TAG_FRAMERX_ERROR              (0x0501)  // Event data type T_XL_ETH_DATAFRAME_RX_ERROR
#define XL_ETH_EVENT_TAG_FRAMETX_ERROR              (0x0506)  // Event data type T_XL_ETH_DATAFRAME_TX_ERROR
#define XL_ETH_EVENT_TAG_FRAMETX_ERROR_SWITCH       (0x0507)  // Event data type T_XL_ETH_DATAFRAME_TX_ERR_SW
#define XL_ETH_EVENT_TAG_FRAMETX_ACK                (0x0510)  // Event data type T_XL_ETH_DATAFRAME_TXACK
#define XL_ETH_EVENT_TAG_FRAMETX_ACK_SWITCH         (0x0511)  // Event data type T_XL_ETH_DATAFRAME_TXACK_SW
#define XL_ETH_EVENT_TAG_FRAMETX_ACK_OTHER_APP      (0x0513)  // Event data type T_XL_ETH_DATAFRAME_TXACK_OTHERAPP
#define XL_ETH_EVENT_TAG_FRAMETX_ERROR_OTHER_APP    (0x0514)  // Event data type T_XL_ETH_DATAFRAME_TX_ERR_OTHERAPP
#define XL_ETH_EVENT_TAG_CHANNEL_STATUS             (0x0520)  // Event data type T_XL_ETH_CHANNEL_STATUS
#define XL_ETH_EVENT_TAG_CONFIGRESULT               (0x0530)  // Event data type T_XL_ETH_CONFIG_RESULT
#define XL_ETH_EVENT_TAG_FRAMERX_SIMULATION (0x0550)  // Event data type T_XL_NET_ETH_DATAFRAME_RX  (with payload)
#define XL_ETH_EVENT_TAG_FRAMERX_ERROR_SIMULATION \
  (0x0551)  // Event data type T_XL_NET_ETH_DATAFRAME_RX_ERROR (with payload)
#define XL_ETH_EVENT_TAG_FRAMETX_ACK_SIMULATION \
  (0x0552)  // Event data type T_XL_NET_ETH_DATAFRAME_SIMULATION_TX_ACK (with payload)
#define XL_ETH_EVENT_TAG_FRAMETX_ERROR_SIMULATION \
  (0x0553)  // Event data type T_XL_NET_ETH_DATAFRAME_SIMULATION_TX_ERROR (with payload)

#define XL_ETH_EVENT_TAG_FRAMERX_MEASUREMENT \
  (0x0560)  // Event data type T_XL_NET_ETH_DATAFRAME_MEASUREMENT_RX  (with payload)
#define XL_ETH_EVENT_TAG_FRAMERX_ERROR_MEASUREMENT \
  (0x0561)  // Event data type T_XL_NET_ETH_DATAFRAME_MEASUREMENT_RX_ERROR (with payload)
#define XL_ETH_EVENT_TAG_FRAMETX_MEASUREMENT \
  (0x0562)  // Event data type T_XL_NET_ETH_DATAFRAME_MEASUREMENT_TX (with payload)
#define XL_ETH_EVENT_TAG_FRAMETX_ERROR_MEASUREMENT \
  (0x0563)  // Event data type T_XL_NET_ETH_DATAFRAME_MEASUREMENT_TX_ERROR (with payload)
#define XL_ETH_EVENT_TAG_LOSTEVENT \
  (0x05fe)  // Indication that one or more intended events could not be generated. Event data type T_XL_ETH_LOSTEVENT
#define XL_ETH_EVENT_TAG_ERROR                   (0x05ff)  // Generic error

//
// ARINC429 event tags
//
#define XL_A429_EV_TAG_TX_OK                     (0x0600)
#define XL_A429_EV_TAG_TX_ERR                    (0x0601)
#define XL_A429_EV_TAG_RX_OK                     (0x0608)
#define XL_A429_EV_TAG_RX_ERR                    (0x0609)
#define XL_A429_EV_TAG_BUS_STATISTIC             (0x060F)
...
#define XL_HWTYPE_VN1614                 56
#define XL_HWTYPE_VN1630                 57
#define XL_HWTYPE_VN1615                 58
...
#define XL_MAX_HWTYPE                    123

#include <pshpack1.h>
#define XL_DAIO_IGNORE_CHANNEL -1
////////////////////////////////////////////////////////////////////////////////
...
#define XL_USE_ALL_CHANNELS      0xFFFFFFFFFFFFFFFF
#define XL_INVALID_CHANNEL_INDEX 0xFFFFFFFF
#define XL_INVALID_DEVICE_INDEX  0xFFFFFFFF
...
#define XL_LIN_MASTER                   0x01    //!< channel is a LIN master
#define XL_LIN_SLAVE                    0x02    //!< channel is a LIN slave
...
#define XL_LIN_FLAG_NO_SLEEP_MODE_EVENT 0x01  //!< No sleep mode event is generated
#define XL_LIN_FLAG_USE_ID_AS_WAKEUPID  0x02  //!< Use the given ID as wakeup ID
// Deprecated
#define XL_LIN_SET_SILENT               XL_LIN_FLAG_NO_SLEEP_MODE_EVENT  //!< Deprecated: set hardware into sleep mode
...
#define XL_LIN_UNDEFINED_DLC       0xff  //!< set the DLC to undefined
...
#define XL_CHANNEL_MASK(x)              (1ULL << (x))
...
#define XL_CAN_STD 0x01  //!< flag for standard ID's
#define XL_CAN_EXT 0x02  //!< flag for extended ID's
...
#define XL_CONNECTION_INFO_FAMILY_MASK               (0xff000000)
#define XL_CONNECTION_INFO_DETAIL_MASK               (0x00ffffff)
...
#define XL_SET_TIMESYNC_NO_CHANGE 0
#define XL_SET_TIMESYNC_ON        1
#define XL_SET_TIMESYNC_OFF       2
...
#define XL_CHANNEL_FLAG_EX_MASK(n)                             (1ULL << n)
// Time-Sync
...
#define XL_FR_CHANNEL_CFG_STATUS_INIT_APP_PRESENT  (0x01)
#define XL_FR_CHANNEL_CFG_STATUS_CHANNEL_ACTIVATED (0x02)
#define XL_FR_CHANNEL_CFG_STATUS_VALID_CLUSTER_CFG (0x04)
#define XL_FR_CHANNEL_CFG_STATUS_VALID_CFG_MODE    (0x08)
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////
#define XL_FR_CHANNEL_A                         (0x01)
#define XL_FR_CHANNEL_B                         (0x02)
#define XL_FR_CHANNEL_AB                        ((XL_FR_CHANNEL_A | XL_FR_CHANNEL_B))
#define XL_FR_CC_COLD_A                         (0x04)  //!< second CC channel A to initiate the coldstart
#define XL_FR_CC_COLD_B                         (0x08)  //!< second CC channel B to initiate the coldstart
#define XL_FR_CC_COLD_AB                        ((XL_FR_CC_COLD_A | XL_FR_CC_COLD_B))
#define XL_FR_SPY_CHANNEL_A                     (0x10)  //!< Spy mode flags
#define XL_FR_SPY_CHANNEL_B                     (0x20)  //!< Spy mode flags

#define XL_FR_QUEUE_OVERFLOW                    (0x0100)  //!< driver queue overflow
...
#define XL_FR_FRAMEFLAG_STARTUP                 (0x0001)  //!< indicates a startup frame
#define XL_FR_FRAMEFLAG_SYNC                    (0x0002)  //!< indicates a sync frame
#define XL_FR_FRAMEFLAG_NULLFRAME               (0x0004)  //!< indicates a null frame
#define XL_FR_FRAMEFLAG_PAYLOAD_PREAMBLE        (0x0008)  //!< indicates a present payload preamble bit
#define XL_FR_FRAMEFLAG_FR_RESERVED             (0x0010)  //!< reserved by Flexray protocol

#define XL_FR_FRAMEFLAG_REQ_TXACK               (0x0020)   //!< used for Tx events only
...
#define XL_FR_FRAMEFLAG_NEW_DATA_TX             (0x0040)  //!< flag used with TxAcks to indicate first TxAck after data update
#define XL_FR_FRAMEFLAG_DATA_UPDATE_LOST        (0x0080)  //!< flag used with TxAcks indicating that data update has been lost

#define XL_FR_FRAMEFLAG_SYNTAX_ERROR            (0x0200)
#define XL_FR_FRAMEFLAG_CONTENT_ERROR           (0x0400)
#define XL_FR_FRAMEFLAG_SLOT_BOUNDARY_VIOLATION (0x0800)
#define XL_FR_FRAMEFLAG_TX_CONFLICT             (0x1000)
#define XL_FR_FRAMEFLAG_EMPTY_SLOT              (0x2000)
#define XL_FR_FRAMEFLAG_FRAME_TRANSMITTED \
  (0x8000)  //!< Only used with TxAcks: Frame has been transmitted. If not set after transmission, an error has occurred.

// XL_FR_SPY_FRAME_EV event: frameError value
#define XL_FR_SPY_FRAMEFLAG_FRAMING_ERROR        (0x01)
#define XL_FR_SPY_FRAMEFLAG_HEADER_CRC_ERROR     (0x02)
#define XL_FR_SPY_FRAMEFLAG_FRAME_CRC_ERROR      (0x04)
#define XL_FR_SPY_FRAMEFLAG_BUS_ERROR            (0x08)

// XL_FR_SPY_FRAME_EV event: frameCRC value
#define XL_FR_SPY_FRAMEFLAG_FRAME_CRC_NEW_LAYOUT (0x80000000)

// XL_FR_SPY_FRAME_EV event: frameFlags value
#define XL_FR_SPY_FRAMEFLAG_STATIC_FRAME         (0x01)

// XL_FR_TX_FRAME event: txMode flags
#define XL_FR_TX_MODE_CYCLIC                     (0x01)  //!< 'normal' cyclic mode
#define XL_FR_TX_MODE_SINGLE_SHOT                (0x02)  //!< sends only a single shot
#define XL_FR_TX_MODE_NONE                          (0xff)  //!< switch off TX

// XL_FR_TX_FRAME event: incrementSize values
#define XL_FR_PAYLOAD_INCREMENT_8BIT                (8)
#define XL_FR_PAYLOAD_INCREMENT_16BIT               (16)
#define XL_FR_PAYLOAD_INCREMENT_32BIT               (32)
#define XL_FR_PAYLOAD_INCREMENT_NONE                (0)
...
#define XL_ETH_EVENT_SIZE_HEADER      32
#define XL_ETH_EVENT_SIZE_MAX         2048

#define XL_ETH_RX_FIFO_QUEUE_SIZE_MAX (64 * 1024 * 1024)  //!< Maximum size of ethernet receive queue: 64 MByte
#define XL_ETH_RX_FIFO_QUEUE_SIZE_MIN (64 * 1024)         //!< Minimum size of ethernet receive queue: 64 KByte

#define XL_ETH_PAYLOAD_SIZE_MAX       1500  // maximum payload length for sending an ethernet packet
#define XL_ETH_PAYLOAD_SIZE_MIN       46  // minimum payload length for sending an ethernet packet (42 octets with VLAN tag present)
#define XL_ETH_RAW_FRAME_SIZE_MAX \
  1600  // maximum buffer size for storing a "raw" Ethernet frame (including VLAN tags, if present)
#define XL_ETH_RAW_FRAME_SIZE_MIN \
  24  // minimum buffer size for storing a "raw" Ethernet frame (including VLAN tags, if present)
...
////////////////////////////////////////////////
#define XL_ETH_CONNECTOR_RJ45            0x0001
#define XL_ETH_CONNECTOR_DSUB            0x0002
#define XL_ETH_PHY_IEEE                  0x0004
#define XL_ETH_PHY_BROADR                0x0008
#define XL_ETH_FRAME_BYPASSED            0x0010  // For Rx and RxError events
#define XL_ETH_QUEUE_OVERFLOW            0x0100
#define XL_ETH_BYPASS_QUEUE_OVERFLOW     0x8000  // MAC bypass queue full condition occurred, one or more packets dropped
...
#define XL_ETH_RX_ERROR_INVALID_LENGTH \
  (0x00000001) /* Invalid length error. Set when the receive frame has an invalid length as defined by IEEE802.3 */
#define XL_ETH_RX_ERROR_INVALID_CRC \
  (0x00000002)                                 /* CRC error. Set when frame is received with CRC-32 error but valid length */
#define XL_ETH_RX_ERROR_PHY_ERROR (0x00000004) /* Corrupted receive frame caused by a PHY error */
...
#define XL_ETH_DATAFRAME_FLAGS_USE_SOURCE_MAC   0x00000001 /* Use the given source MAC address (not set by hardware) */
...
#define XL_ETH_NETWORK_TX_ERROR_NO_LINK               0x00000001 /* No Link */
#define XL_ETH_NETWORK_TX_ERROR_PHY_NOT_CONFIGURED    0x00000002 /* PHY not yet configured */
#define XL_ETH_NETWORK_TX_ERROR_PHY_BRIDGE_ENABLED    0x00000004 /* PHY Bypass activated */
#define XL_ETH_NETWORK_TX_ERROR_CONVERTER_RESET       0x00000008 /* RGMII Converter in reset */
#define XL_ETH_NETWORK_TX_ERROR_INVALID_LENGTH \
  (0x00000010) /* Invalid length error. Set when the frame has an invalid length as defined by IEEE802.3 */
#define XL_ETH_NETWORK_TX_ERROR_INVALID_CRC \
  (0x00000020) /* CRC error. Set when frame is transmitted with CRC-32 error but valid length */
#define XL_ETH_NETWORK_TX_ERROR_MACADDR_ERROR        (0x00000040) /* Invalid src or dest MAC address */
...
#define XL_ETH_NETWORK_RX_ERROR_INVALID_CRC \
  (0x00000002) /* CRC error. Set when frame is received with CRC-32 error but valid length */
#define XL_ETH_NETWORK_RX_ERROR_PHY_ERROR     (0x00000004) /* Corrupted receive frame caused by a PHY error */
#define XL_ETH_NETWORK_RX_ERROR_MACADDR_ERROR (0x00000008) /* Invalid src or dest MAC address */
...
#define XL_ACCESS_TYPE_UNRELIABLE              (0x00000000)  // Only for Ethernet uplink, means UDP transfers. (Not supported yet)
#define XL_ACCESS_TYPE_RELIABLE                (0x00000001)  // Always for USB uplink or TCP for Ethernet host uplink
////////////////////////////////////////////////////////////////////////////////
...
#define XL_MOST150_RX_EVENT_HEADER_SIZE             32
#define XL_MOST150_MAX_EVENT_DATA_SIZE              2048
#define MOST150_SYNC_ALLOC_INFO_SIZE                372

#define XL_MOST150_CTRL_PAYLOAD_MAX_SIZE            45
#define XL_MOST150_ASYNC_PAYLOAD_MAX_SIZE           1524  // maximum valid length (s. INIC User Manual)
#define XL_MOST150_ETHERNET_PAYLOAD_MAX_SIZE        1506  // maximum valid length (s. INIC User Manual)
#define XL_MOST150_ASYNC_SEND_PAYLOAD_MAX_SIZE      1600  // maximum length for sending a MDP
#define XL_MOST150_ETHERNET_SEND_PAYLOAD_MAX_SIZE   1600  // maximum length for sending a MEP

/////////////////////////////////////////////////////////////////////////////////////////////////////////
// Flags for the flagsChip parameter
/////////////////////////////////////////////////////////////////////////////////////////////////////////
#define XL_MOST150_VN2640                           0x0001  //!< common VN2640 event
#define XL_MOST150_INIC                             0x0002  //!< event was generated by INIC
#define XL_MOST150_SPY                              0x0004  //!< event was generated by spy
#define XL_MOST150_QUEUE_OVERFLOW                   0x0100  //!< queue overflow occured (some events are lost)

// XL_MOST150_EVENT_SOURCE_EV.mask
#define XL_MOST150_SOURCE_SPECIAL_NODE              0x00000001
#define XL_MOST150_SOURCE_SYNC_ALLOC_INFO           0x00000004
#define XL_MOST150_SOURCE_CTRL_SPY                  0x00000008
#define XL_MOST150_SOURCE_ASYNC_SPY                 0x00000010
#define XL_MOST150_SOURCE_ETH_SPY                   0x00000020
#define XL_MOST150_SOURCE_SHUTDOWN_FLAG             0x00000040
#define XL_MOST150_SOURCE_SYSTEMLOCK_FLAG           0x00000080
#define XL_MOST150_SOURCE_LIGHTLOCK_SPY             0x00000200
#define XL_MOST150_SOURCE_LIGHTLOCK_INIC            0x00000400
#define XL_MOST150_SOURCE_ECL_CHANGE                0x00000800
#define XL_MOST150_SOURCE_LIGHT_STRESS              0x00001000
#define XL_MOST150_SOURCE_LOCK_STRESS               0x00002000
#define XL_MOST150_SOURCE_BUSLOAD_CTRL              0x00004000
#define XL_MOST150_SOURCE_BUSLOAD_ASYNC             0x00008000
#define XL_MOST150_SOURCE_CTRL_MLB                  0x00010000
#define XL_MOST150_SOURCE_ASYNC_MLB                 0x00020000
#define XL_MOST150_SOURCE_ETH_MLB                   0x00040000
#define XL_MOST150_SOURCE_TXACK_MLB                 0x00080000
#define XL_MOST150_SOURCE_STREAM_UNDERFLOW          0x00100000
#define XL_MOST150_SOURCE_STREAM_OVERFLOW           0x00200000
#define XL_MOST150_SOURCE_STREAM_RX_DATA            0x00400000
#define XL_MOST150_SOURCE_ECL_SEQUENCE              0x00800000

// XL_MOST150_DEVICE_MODE_EV.deviceMode
#define XL_MOST150_DEVICEMODE_SLAVE                 0x00
#define XL_MOST150_DEVICEMODE_MASTER                0x01
#define XL_MOST150_DEVICEMODE_STATIC_MASTER         0x03
#define XL_MOST150_DEVICEMODE_RETIMED_BYPASS_SLAVE  0x04
#define XL_MOST150_DEVICEMODE_RETIMED_BYPASS_MASTER 0x05

// XL_MOST150_FREQUENCY_EV.frequency
#define XL_MOST150_FREQUENCY_44100                  0x00000000
#define XL_MOST150_FREQUENCY_48000                  0x00000001
#define XL_MOST150_FREQUENCY_ERROR                  0x00000002

// XL_MOST150_SPECIAL_NODE_INFO_EV.changeMask
#define XL_MOST150_NA_CHANGED                       0x00000001
#define XL_MOST150_GA_CHANGED                       0x00000002
#define XL_MOST150_NPR_CHANGED                      0x00000004
#define XL_MOST150_MPR_CHANGED                      0x00000008
#define XL_MOST150_SBC_CHANGED                      0x00000010
#define XL_MOST150_CTRL_RETRY_PARAMS_CHANGED        0x00000060
#define XL_MOST150_ASYNC_RETRY_PARAMS_CHANGED       0x00000180
#define XL_MOST150_MAC_ADDR_CHANGED                 0x00000200
#define XL_MOST150_NPR_SPY_CHANGED                  0x00000400
#define XL_MOST150_MPR_SPY_CHANGED                  0x00000800
#define XL_MOST150_SBC_SPY_CHANGED                  0x00001000
#define XL_MOST150_INIC_NISTATE_CHANGED             0x00002000
#define XL_MOST150_SPECIAL_NODE_MASK_CHANGED        0x00003FFF

// Retry Parameters
#define XL_MOST150_CTRL_RETRY_TIME_MIN              3  // Time Unit: 16 MOST Frames
#define XL_MOST150_CTRL_RETRY_TIME_MAX              31
#define XL_MOST150_CTRL_SEND_ATTEMPT_MIN            1
#define XL_MOST150_CTRL_SEND_ATTEMPT_MAX            16
#define XL_MOST150_ASYNC_RETRY_TIME_MIN             0  // Time Unit: 1 MOST Frame
#define XL_MOST150_ASYNC_RETRY_TIME_MAX             255
#define XL_MOST150_ASYNC_SEND_ATTEMPT_MIN           1  // For both MDP and MEP
#define XL_MOST150_ASYNC_SEND_ATTEMPT_MAX           16

// NIStates
#define XL_MOST150_INIC_NISTATE_NET_OFF             0x00000000
#define XL_MOST150_INIC_NISTATE_NET_INIT            0x00000001
#define XL_MOST150_INIC_NISTATE_NET_RBD             0x00000002
#define XL_MOST150_INIC_NISTATE_NET_ON              0x00000003
#define XL_MOST150_INIC_NISTATE_NET_RBD_RESULT      0x00000004

// XL_MOST150_CTRL_TX_ACK_EV.status
#define XL_MOST150_TX_OK                            0x00000001
#define XL_MOST150_TX_FAILED_FORMAT_ERROR           0x00000002
#define XL_MOST150_TX_FAILED_NETWORK_OFF            0x00000004
#define XL_MOST150_TX_FAILED_TIMEOUT                0x00000005
#define XL_MOST150_TX_FAILED_WRONG_TARGET           0x00000008
#define XL_MOST150_TX_OK_ONE_SUCCESS                0x00000009
#define XL_MOST150_TX_FAILED_BAD_CRC                0x0000000C
#define XL_MOST150_TX_FAILED_RECEIVER_BUFFER_FULL   0x0000000E

// XL_MOST150_CTRL_SPY_EV.validMask
// XL_MOST150_ASYNC_SPY_EV.validMask
// XL_MOST150_ETHERNET_SPY_EV.validMask
#define XL_MOST150_VALID_DATALENANNOUNCED           0x00000001
#define XL_MOST150_VALID_SOURCEADDRESS              0x00000002
#define XL_MOST150_VALID_TARGETADDRESS              0x00000004
#define XL_MOST150_VALID_PACK                       0x00000008
#define XL_MOST150_VALID_CACK                       0x00000010
#define XL_MOST150_VALID_PINDEX                     0x00000020
#define XL_MOST150_VALID_PRIORITY                   0x00000040
#define XL_MOST150_VALID_CRC                        0x00000080
#define XL_MOST150_VALID_CRCCALCULATED              0x00000100
#define XL_MOST150_VALID_MESSAGE                    0x80000000

// XL_MOST150_CTRL_SPY_EV.pAck
// XL_MOST150_ASYNC_SPY_EV.pAck
// XL_MOST150_ETHERNET_SPY_EV.pAck
#define XL_MOST150_PACK_OK                          0x00000004
#define XL_MOST150_PACK_BUFFER_FULL                 0x00000001
#define XL_MOST150_PACK_NO_RESPONSE                 0x00000000  // maybe spy before receiver

// XL_MOST150_CTRL_SPY_EV.cAck
// XL_MOST150_ASYNC_SPY_EV.cAck
// XL_MOST150_ETHERNET_SPY_EV.cAck
#define XL_MOST150_CACK_OK                          0x00000004
#define XL_MOST150_CACK_CRC_ERROR                   0x00000001
#define XL_MOST150_CACK_NO_RESPONSE                 0x00000000  // maybe spy before receiver

//XL_MOST150_ASYNC_RX_EV.length
#define XL_MOST150_ASYNC_INVALID_RX_LENGTH \
  0x00008000  // flag indicating a received MDP with length > XL_MOST150_ASYNC_PAYLOAD_MAX_SIZE

//XL_MOST150_ETHERNET_RX_EV.length
#define XL_MOST150_ETHERNET_INVALID_RX_LENGTH \
  0x80000000  // flag indicating a received MEP with length > XL_MOST150_ETHERNET_PAYLOAD_MAX_SIZE

// XL_MOST150_TX_LIGHT_EV.light
#define XL_MOST150_LIGHT_OFF                             0x00000000
#define XL_MOST150_LIGHT_FORCE_ON                        0x00000001
#define XL_MOST150_LIGHT_MODULATED                       0x00000002

// XL_MOST150_RXLIGHT_LOCKSTATUS_EV.status
//#define XL_MOST150_LIGHT_OFF                              0x00000000
#define XL_MOST150_LIGHT_ON_UNLOCK                       0x00000003
#define XL_MOST150_LIGHT_ON_LOCK                         0x00000004
#define XL_MOST150_LIGHT_ON_STABLE_LOCK                  0x00000005
#define XL_MOST150_LIGHT_ON_CRITICAL_UNLOCK              0x00000006

// XL_MOST150_ERROR_EV.errorCode
#define XL_MOST150_ERROR_ASYNC_TX_ACK_HANDLE             0x00000001
#define XL_MOST150_ERROR_ETH_TX_ACK_HANDLE               0x00000002

// XL_MOST150_CONFIGURE_RX_BUFFER_EV.bufferType
#define XL_MOST150_RX_BUFFER_TYPE_CTRL                   0x00000001
#define XL_MOST150_RX_BUFFER_TYPE_ASYNC                  0x00000002

// XL_MOST150_CONFIGURE_RX_BUFFER_EV.bufferMode
#define XL_MOST150_RX_BUFFER_NORMAL_MODE                 0x00000000
#define XL_MOST150_RX_BUFFER_BLOCK_MODE                  0x00000001

// XL_MOST150_CTRL_SYNC_AUDIO_EV.device
#define XL_MOST150_DEVICE_LINE_IN                        0x00000000
#define XL_MOST150_DEVICE_LINE_OUT                       0x00000001
#define XL_MOST150_DEVICE_SPDIF_IN                       0x00000002
#define XL_MOST150_DEVICE_SPDIF_OUT                      0x00000003
#define XL_MOST150_DEVICE_ALLOC_BANDWIDTH                0x00000004

// XL_MOST150_CTRL_SYNC_AUDIO_EV.mode
#define XL_MOST150_DEVICE_MODE_OFF                       0x00000000
#define XL_MOST150_DEVICE_MODE_ON                        0x00000001
#define XL_MOST150_DEVICE_MODE_OFF_BYPASS_CLOSED         0x00000002
#define XL_MOST150_DEVICE_MODE_OFF_NOT_IN_NETON          0x00000003
#define XL_MOST150_DEVICE_MODE_OFF_NO_MORE_RESOURCES     0x00000004
#define XL_MOST150_DEVICE_MODE_OFF_NOT_ENOUGH_FREE_BW    0x00000005
#define XL_MOST150_DEVICE_MODE_OFF_DUE_TO_NET_OFF        0x00000006
#define XL_MOST150_DEVICE_MODE_OFF_DUE_TO_CFG_NOT_OK     0x00000007
#define XL_MOST150_DEVICE_MODE_OFF_COMMUNICATION_ERROR   0x00000008
#define XL_MOST150_DEVICE_MODE_OFF_STREAM_CONN_ERROR     0x00000009
#define XL_MOST150_DEVICE_MODE_OFF_CL_ALREADY_USED       0x0000000A
#define XL_MOST150_DEVICE_MODE_CL_NOT_ALLOCATED          0x000000FF
...
#define XL_MOST150_CL_DEALLOC_ALL                        0x00000FFF

// XL_MOST150_SYNC_VOLUME_STATUS_EV.volume
#define XL_MOST150_VOLUME_MIN                            0x00000000
#define XL_MOST150_VOLUME_MAX                            0x000000FF

// XL_MOST150_SYNC_MUTE_STATUS_EV.mute
#define XL_MOST150_NO_MUTE                               0x00000000
#define XL_MOST150_MUTE                                  0x00000001

// XL_MOST150_LIGHT_POWER_EV.lightPower
#define XL_MOST150_LIGHT_FULL                            0x00000064
#define XL_MOST150_LIGHT_3DB                             0x00000032

// XL_MOST150_SYSTEMLOCK_FLAG_EV.state
#define XL_MOST150_SYSTEMLOCK_FLAG_NOT_SET               0x00000000
#define XL_MOST150_SYSTEMLOCK_FLAG_SET                   0x00000001

// XL_MOST150_SHUTDOWN_FLAG_EV.state
#define XL_MOST150_SHUTDOWN_FLAG_NOT_SET                 0x00000000
#define XL_MOST150_SHUTDOWN_FLAG_SET                     0x00000001

// ECL
// xlMost150SetECLLine
#define XL_MOST150_ECL_LINE_LOW                          0x00000000
#define XL_MOST150_ECL_LINE_HIGH                         0x00000001
// xlMost150SetECLTermination
#define XL_MOST150_ECL_LINE_PULL_UP_NOT_ACTIVE           0x00000000
#define XL_MOST150_ECL_LINE_PULL_UP_ACTIVE               0x00000001
...
#define XL_MOST150_SPDIF_MODE_SLAVE                      0x00000000
#define XL_MOST150_SPDIF_MODE_MASTER                     0x00000001

// XL_MOST150_SPDIF_MODE_EV.spdifError
#define XL_MOST150_SPDIF_ERR_NO_ERROR                    0x00000000
#define XL_MOST150_SPDIF_ERR_HW_COMMUNICATION            0x00000001

// XL_MOST150_NW_STARTUP_EV.error
#define XL_MOST150_STARTUP_NO_ERROR                      0x00000000
// XL_MOST150_NW_STARTUP_EV.errorInfo
#define XL_MOST150_STARTUP_NO_ERRORINFO                  0xFFFFFFFF

// XL_MOST150_NW_SHUTDOWN_EV.error
#define XL_MOST150_SHUTDOWN_NO_ERROR                     0x00000000
// XL_MOST150_NW_SHUTDOWN_EV.errorInfo
#define XL_MOST150_SHUTDOWN_NO_ERRORINFO                 0xFFFFFFFF
...
#define XL_MOST150_STREAM_CL_MIN                         0x000C
#define XL_MOST150_STREAM_CL_MAX                         0x017F
...
#define XL_MOST150_SSO_RESULT_NO_RESULT                  0x00000000
#define XL_MOST150_SSO_RESULT_NO_FAULT_SAVED             0x00000001
#define XL_MOST150_SSO_RESULT_SUDDEN_SIGNAL_OFF          0x00000002
#define XL_MOST150_SSO_RESULT_CRITICAL_UNLOCK            0x00000003
...
It returns XL_ERR_QUEUE_IS_EMPTY and *pEventCount=0 if no event
was received.
 ...
 *   If the XL API function xlResetClock() was not called, the event timestamp can be compared
 *   to the time retrieved from other xlGetSyncTime() calls.
 *   Any other time synchronization method is not supported.
 *
 *   \param[in]  portHandle               the port handle retrieved by xlOpenPort()
...
DECL_STDXL_FUNC(xlLinSetDLC, XLLINSETDLC, (XLportHandle portHandle, XLaccess accessMask, char *dlc));
DECL_STDXL_FUNC(xlLinSetSlave, XLLINSETSLAVE,
                (XLportHandle portHandle, XLaccess accessMask, unsigned char linId, char *data, unsigned char dlc,
...
DECL_STDXL_FUNC(xlLinSetChecksum, XLLINSETCHECKSUM, (XLportHandle portHandle, XLaccess accessMask, char *checksum));
...
DECL_STDXL_FUNC(xlMostWriteRegister, XLFP_MOSTWRITEREGISTER,
                (DEFPARAMS, unsigned short adr, unsigned char numBytes, char *data));
 ...
 *  \return XLstatus                       general status information
 */
DECL_STDXL_FUNC(xlMostCtrlSyncAudio, XLFP_MOSTCTRLSYNCAUDIO, (DEFPARAMS, unsigned int *channel, unsigned int device, unsigned int mode));
...
DECL_STDXL_FUNC(xlMostCtrlSyncAudioEx, XLFP_MOSTCTRLSYNCAUDIOEX,
                (DEFPARAMS, unsigned int *channel, unsigned int device, unsigned int mode));
 ...
 *  \return XLstatus                       general status information
 */
DECL_STDXL_FUNC(xlMostStreamStart, XLFP_MOSTSTREAMSTART, (DEFPARAMS, unsigned int streamHandle, char *syncChannels));
...
*   To create an external HW/SW-Sync Slave/Master clock context or to
*    open the existing domain clock and query the current time.
*
*   An error is returned when there already exists a master / slave clock
*    for the requested protocol.
*
*   Finally callers must call xlTsDestroyClock() to cleanup the context.
*
*   \param[out] pClockHandle             handle returned by DLL to access the clock context
*   \param[in]  timeDomainName           the name of the domain to register the clock (currently, only the Default Time Domain is supported
by the API)
*   \param[in]  clkType                  the type of the external clock
*   \param[in]  apiVersion               the version of the API to be used by application
*   \return XLstatus                     status information
*/
 ...
 *
 *   \param[in] clockHandle             the handle to access the clock context
 *   \return XLstatus                   status information
 */

DECL_STDXL_FUNC(xlTsDestroyClock, XLFP_TSDESTROYCLOCK, (XLtsClockHandle clockHandle));

/** \brief Reads the current time on the domain

*   Reads the current time from the TSS internal software synchronized
*    clock for this domain.
*   The parameter 'slaveTime' contains the value of the Performance Counter.
*
*   \param[in]  clockHandle           the handle to access the clock context
*   \param[out] domainTime            time info on the domain
*   \param[out] slaveTime             Performance Counter
*   \return XLstatus                  XL_SUCCESS on success
*                                     XL_ERR_TS_DOMAIN_NOT_SYNC the domain is not synchronized to one master or same timescale
...
*
*   \param[in]  statusPortHandle       the handle of the port (XL_BUS_TYPE_STATUS) to send the notification
*   \param[in]  portHandle             the handle of the port to monitor; if XL_INVALID_PORTHANDLE, the notification will be sent for all ports;
*                                      must be XL_INVALID_PORTHANDLE
...
*   If using the notification event first register the Event, then call xlTsGetStatus.
*
*   \param[in]  statusPortHandle       the handle of the port (XL_BUS_TYPE_STATUS) to send the notification
*   \param[in]  networkHandle          the handle of the network to monitor; if XL_INVALID_NETWORKHANDLE, the notification will be sent for all networks;
*                                      must be XL_INVALID_NETWORKHANDLE
*   \param[out] pHandle                output handle object; this will be owned by the status port
*   \return     XLstatus               status information
*/
